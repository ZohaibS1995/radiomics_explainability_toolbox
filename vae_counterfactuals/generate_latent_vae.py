...
for step, batch in progress_bar:
    ...
    # adding to the list
    dict_fold_latent_train[fold_no].append(latent.detach().cpu().squeeze().numpy().flatten())
...
for step, batch in progress_bar:
    ...
    # adding to the list
    dict_fold_latent_val[fold_no].append(latent.detach().cpu().squeeze().numpy().flatten())
